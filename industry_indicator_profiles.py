...
INDUSTRY_PROFILES = {
    ...
    "CONSTRUCTION": _profile("XÂY DỰNG - ĐẦU TƯ CÔNG", ("rev", "receivables", "cfo", "npat"),
    ...
    "BUILDING_MATERIALS": _profile("VẬT LIỆU XÂY DỰNG", ("rev", "gross_profit", "inventory", "npat"),
    ...
    "FOOD_BEVERAGE": _profile("THỰC PHẨM & ĐỒ UỐNG", ("rev", "gross_profit", "inventory", "npat"),
